...
void GameView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onRestartButtonClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameView::*)()>(_a, &GameView::playerExplosionFinished, 0))
            return;
    }
}
...
// SIGNAL 0
void GameView::playerExplosionFinished()
{
